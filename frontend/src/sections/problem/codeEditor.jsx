...
import { Lock, Cpu, Construction,Code, ServerCrash  } from "lucide-react";
...
const ComingSoonOverlay = ({ language }) => (
  <div className="h-full w-full flex flex-col items-center justify-center bg-[#09090b] relative overflow-hidden text-center p-6 select-none">
    ...
    {/* 1. Background: Blueprint Grid & Radial Glow */}
    <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]"></div>
    <div className="absolute inset-0 bg-gradient-to-t from-[#09090b] via-transparent to-transparent"></div>
    
    {/* 2. Central Holographic Container */}
...
function CodeEditor({ code, language = "python" }) {
  ...
  // If code is null, undefined, or empty string, show the Futuristic UI
  if (!code) {
    return (
  ...
  return (
    ...
    <div className="h-full w-full relative overflow-hidden bg-[#282a36]">
      {/* overflow-auto allows scrolling ONLY here */}
